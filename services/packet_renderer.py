...
def render_agent_prompt(packet: Dict[str, Any]) -> str:
    ...
    parts.append("Use this Markdown structure for your final completion report. Preserve normal human-readable text in the final report. Do not include XML/HTML escaping in the final report unless the escaped form is part of the intended literal content.\n")
