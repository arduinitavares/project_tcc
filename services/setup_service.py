...
async def run_project_setup(
    *,
    ...
    refresh_project_context: Callable[[int, Any], Any],
    ...
    refresh_project_context(project_id, tool_context)
    ...
    if not setup_passed:
        ...
        latest_product = load_project(project_id)
        blocker = setup_blocker(latest_product)
        if blocker:
            setup_passed = False
    ...
    save_session_state(session_id, context.state)
