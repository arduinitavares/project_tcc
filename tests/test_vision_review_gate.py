...
class TestVisionReviewGate(unittest.TestCase):
    ...
    def test_routing_mode_vision_complete_transitions_to_review(self) -> None:
    ...
    def test_vision_review_save_transitions_to_persistence(self) -> None:
    ...
    def test_routing_instruction_does_not_embed_save_recipe(self) -> None:
        ...
        assert section3_match is not None, "Section 3 not found in ROUTING instruction"
        section3_text = section3_match.group()

        assert "save_vision_tool" not in section3_text, "ROUTING section 3 must NOT contain an inline save_vision_tool recipe. " "The agent should STOP after product_vision_tool and let the FSM " "transition to VISION_REVIEW for user approval."  # noqa: E501

    def test_routing_instruction_does_not_embed_spec_save_recipe(self) -> None:
        ...
        assert section4_match is not None, "Section 4 not found in ROUTING instruction"
        section4_text = section4_match.group()

        assert "save_vision_tool" not in section4_text, "ROUTING section 4 must NOT contain an inline save_vision_tool recipe."  # noqa: E501

    # --- VISION_PERSISTENCE is a pure confirmation state ---

    def test_vision_persistence_does_not_have_link_spec_to_product(self) -> None:
        ...
        assert "link_spec_to_product" not in tool_names, "VISION_PERSISTENCE must NOT contain link_spec_to_product. " "Spec linking is handled internally by save_vision_tool."  # noqa: E501

    def test_routing_mode_does_not_have_link_spec_to_product(self) -> None:
        ...
        assert "link_spec_to_product" not in tool_names, "SETUP_REQUIRED must NOT contain link_spec_to_product."  # noqa: E501

    def test_vision_persistence_only_has_backlog_primer(self) -> None:
        ...
        assert tool_names == ["backlog_primer_tool"], "VISION_PERSISTENCE should only have backlog_primer_tool."  # noqa: E501
