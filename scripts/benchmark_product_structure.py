...
def seed_database(
    ...
    with Session(engine) as session:
        ...
        session.commit()
    print(
        f"Seeded DB with {product_count} products, {themes_per_product} themes/prod, {epics_per_theme} epics/theme, {features_per_epic} features/epic, {stories_per_feature} stories/feature."
    )
